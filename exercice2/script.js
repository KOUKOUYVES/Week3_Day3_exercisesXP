...
creationDiv1.appendChild(reationDiv2);//ici nois avons remplacer id de la premiere div par outer
animate.appendChild(creationDiv1);//ici nois avons remplacer id de la deuxieme div par iner
